# Generated by Django 5.2.5 on 2025-08-24 07:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chat_id', models.CharField(blank=True, max_length=128, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('ACTIVE', 'Active'), ('USED', 'Used'), ('EXPIRED', 'Expired'), ('INACTIVE', 'Inactive')], default='ACTIVE', max_length=8)),
                ('qr_type', models.CharField(choices=[('STATIC', 'Static'), ('DYNAMIC', 'Dynamic')], max_length=8)),
                ...
                ('partner', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
            fields=[
                ...
                ('status', models.PositiveSmallIntegerField(choices=[(0, 'Created'), (1, 'Success'), (2, 'Failed')], default=0)),
                ('description', models.CharField(max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('qr', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='v1.terminal')),
            ],
        ),
    ]
